...
- Experience any navigational challenges or have thoughts about the dashboard, curation workflow, or collection? We welcome your feedback and kindly ask to fill out this [form](https://forms.gle/uyovpTRTMpYbvoV57) so we may improve the usability of this resource.
...
> - Included standard curations cannot be removed once they have been added to the dashboard. In unique circumstances where this may be required, please get in touch with the MOMSI WG Co-chairs. *Records with a "deprecated" status at the dashboard are removed from our MOMSI FAIRsharing collection to remain as accurate as possible for community users. 
> - This policy is aimed to encourage continuous curation and transparency in mapping standard relationship lineage (where applicable) and to identify any potential dependencies that may exist between standards (depreciation vs. deprecation). Visit the [Glossary Table](https://rda-momsi.github.io/Dashboard/glossary#glossary-table) to determine which Status curation term is best.
